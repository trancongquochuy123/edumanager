    ...
    <div className="flex h-screen overflow-hidden bg-[#fdf2f8]">
        ...
        <div className="p-4 border-t border-pink-100">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-pink-50">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 truncate">admin@edu.vn</p>
            </div>
          </div>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="bg-white border-b border-pink-100 px-4 lg:px-6 py-3.5 flex items-center gap-4 flex-shrink-0">
          <button
            className="lg:hidden p-2 rounded-lg text-gray-500 hover:bg-pink-50 hover:text-pink-600 transition-colors"
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-pink-400 to-rose-400 flex items-center justify-center text-white text-xs font-bold cursor-pointer hover:shadow-md transition-shadow">
              AD
            </div>
          </div>
        </header>
